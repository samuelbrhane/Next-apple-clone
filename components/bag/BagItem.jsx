      ...
      <div className="flex items-center flex-col sm:flex-row border-b-4 py-3 md:py-5 justify-between">
        ...
        <div className="w-[90%] sm:w-[75%]">
          <div className="flex items-center border-b-2 justify-between py-2">
            ...
            <div className="flex flex-col items-center mr-4 md:mr-8 lg:mr-12 font-bold text-sm md:text-[16px]">
              <AiOutlineUp className="text-sm text-blue-500 cursor-pointer" />
              <p>{amount}</p>
              <AiOutlineDown className="text-sm text-blue-500 cursor-pointer" />
            </div>
